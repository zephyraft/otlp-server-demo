...
import com.zephyraft.otel.service.LogsServiceImpl;
import com.zephyraft.otel.service.MetricsServiceImpl;
import com.zephyraft.otel.service.TracesServiceImpl;
...
public class OtlpServer {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        final OtlpServer server = new OtlpServer();
        server.start();
